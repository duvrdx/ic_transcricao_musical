...
class Model(object):
    def __init__(self, labels, checkpoint_path, init=False, window=16384, outputs=1, stride=512, normalize=True, gpu_memory_growth=True, extended_test_set=True, use_mirex=False, pitch_transforms=0, mmap=True, batch_size=150, jitter=0, breakdowns=True, restrict=True):
        self.labels = labels
